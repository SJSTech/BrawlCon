...
const client = new Client({ intents: [Intents.FLAGS.GUILDS], ws: { properties: { $browser: "Discord iOS" }} });
...
client.on("ready", () => {
 ...
 client.user.setPresence({ activity: { name: 'Con Co. | BrawlCon.com' }, status: 'online' });
